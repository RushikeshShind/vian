...
const Projects = () => {
  ...
  return <Fragment>
      ...
      <header className="wrapper bg-gray" style={{fontFamily:'Arial'}}>
      ...
      <section className="wrapper image-wrapper bg-image bg-overlay bg-overlay-400 text-white" style={{
            ...
            <div className="container py-13 py-md-17 text-center">
              <div className="row">
                <div className="col-lg-10 col-xxl-8 mx-auto">
                  <h1 className="display-1 mb-1" style={{color:'white', fontFamily:'Arial'}}>OUR VISION
                  </h1>
        ...
        <div className="container py-14 py-md-1"style={{fontFamily:'Arial'}}>
          <div className="row mt-6">
            
            <div ><div className="col-xl-10 mx-auto">
              <div className=" display-1 projects-tiles text-center">
                ...
                <div className="row align-items-center mb-1">
                  ...
                  {/* Content Column */}
                  <div className="col-md-16"style={{fontFamily:'Arial'}}>
                    <h3 className="display-6 ls-sm  text-center" style={{fontFamily:'Arial'}}>
