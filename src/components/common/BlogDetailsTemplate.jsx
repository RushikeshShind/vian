...
const BlogDetailsTemplate = () => {
  ...
  return <div className="card">
      <FigureImage width={660} height={600} src="/img/photos/picture3.png" className="card-img-top" />

      <div className="card-body">
        <div className="classic-view">
          <article className="post">
            <div className="post-content mb-5">
              <h2 className="h1 mb-4">Conceptual Design
             </h2>
              <p>
                ...
                full
                    ...
                    <figure className="hover-scale rounded cursor-dark">
                      <a href={full} data-glightbox data-gallery="post">
                        <Image width={460} height={307} src={url} alt="demo" style={{
                      width: '100%',
                      height: 'auto'
                    }} />
                      </a>
